...
## for the following GCP credential types:
...
## Uncomment the following lines to set up the Boundary host catalog and host sets.
...
## Uncomment the following to set up a host catalog using service account impersonation
...
## Uncomment the following to set up a host catalog using Application Default Credentials (ADC)
